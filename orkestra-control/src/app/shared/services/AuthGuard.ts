...
export class AuthGuard extends KeycloakAuthGuard {
  ...
  public async isAccessAllowed(
    ...
    //check whether public folder or not
    let publicFolder = this.keycloak.excludedUrls.some((pat)=>{
          if (pat.urlPattern.test(state.url)) return true;
          return false;
    })
    if (publicFolder) return true;
